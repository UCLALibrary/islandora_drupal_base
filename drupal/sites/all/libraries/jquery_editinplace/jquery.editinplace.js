...
A jQuery edit in place plugin.  Updated to work with Jarrow's package.

Version 2.3.1

Authors:
	Dave Hauenstein
	Martin HÃƒÂ¤cker <spamfaenger [at] gmx [dot] de>
...
(function($){
  ...
  $.fn.editInPlace.defaults = {
    ...
    save_button:		'<button class="inplace_save">Save</button>', // string: image button tag to use as Ã¢â‚¬Å“SaveÃ¢â‚¬Â� button
    cancel_button:		'<button class="inplace_cancel">Cancel</button>', // string: image button tag to use as Ã¢â‚¬Å“CancelÃ¢â‚¬Â� button
  ...
  $.extend(InlineEditor.prototype, {
    ...
    replaceContentWithEditor: function() {
      ...
      this.dom.html('')
      //.html('<form class="inplace_form" style="display: inline; margin: 0; padding: 0;"></form>')
      //.find('form')
    ...
    connectClosingEventsToEditor: function() {
      ...
      form.find(".inplace_field").focus().select().keypress(function (anEvent) {
        //Prevent form submission on enter.
        if(anEvent.which == 13) {
          anEvent.preventDefault();
          saveEditorAction(anEvent);
        }
    ...
    bindSubmitOnEnterInInput: function() {
      ...
      this.dom.find(':input').keyup(function(event) {
        ...
        return false;//that.dom.find('form').submit();
      });
    ...
    startSavingAnimation: function() {
      ...
      this.dom
      .animate({
        backgroundColor: this.settings.saving_animation_color
        }, 400)
      .animate({
