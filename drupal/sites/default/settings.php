...
/**
 * Things to update when cloning this file for DLP project:
 *   $databases password
 *   $drupal_hash_salt file location
 */
...
$databases = array (
  ...
  array (
    ...
    array (
      ...
      'password' => file_get_contents('/etc/drupal/default_db.txt'),
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
 ...
 *
 */
$drupal_hash_salt = file_get_contents('/etc/drupal/default_hash.txt');
